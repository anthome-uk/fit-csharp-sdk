...
namespace Dynastream.Fit
{
    ...
    public class SessionMesg : Mesg
    {
        ...
        public sealed class FieldDefNum
        {
            ...
            public const byte MetabolicCalories = 196;
        ...
        {
            Object val = GetFieldValue(196, 0, Fit.SubfieldIndexMainField);
            if(val == null)
            {
                return null;
            }
        ...
        {
            SetFieldValue(196, 0, metabolicCalories_, Fit.SubfieldIndexMainField);
        }
