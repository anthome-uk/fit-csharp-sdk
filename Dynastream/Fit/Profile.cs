...
namespace Dynastream.Fit
{
    ...
    public static class Profile
    {
        ...
        private static Mesg CreateTrainingSettingsMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("TrainingSettings", MesgNum.TrainingSettings);
            fieldIndex = 0;
            newMesg.SetField(new Field("TargetDistance", 31, 134, 100, 0, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("TargetSpeed", 32, 132, 1000, 0, "m/s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("TargetTime", 33, 134, 1, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("PreciseTargetSpeed", 153, 134, 1000000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
        ...
        private static Mesg CreateSessionMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("EndPositionLat", 38, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("EndPositionLong", 39, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("SportProfileName", 110, 7, 1, 0, "", false, Type.String));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("MetabolicCalories", 196, 132, 1, 0, "kcal", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("SdrrHrv", 197, 2, 1, 0, "mS", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("RmssdHrv", 198, 2, 1, 0, "mS", false, Type.Uint8));
            fieldIndex++;
        ...
        private static Mesg CreateRecordMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("CycleLength16", 87, 132, 100, 0, "m", false, Type.Uint16));
            fieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("CurrentStress", 116, 132, 100, 0, "", false, Type.Uint16));
            fieldIndex++;
        ...
        private static Mesg CreateEventMesg()
        {
            ...
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AutoActivityDetectDuration", 132, 1, 0, "min"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(0, 54);
            subfieldIndex++;
            ...
            fieldIndex++;
            newMesg.SetField(new Field("ActivityType", 14, 0, 1, 0, "", false, Type.ActivityType));
            fieldIndex++;
            newMesg.SetField(new Field("StartTimestamp", 15, 134, 1, 0, "s", false, Type.DateTime));
            subfieldIndex = 0;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("AutoActivityDetectStartTimestamp", 134, 1, 0, "s"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(0, 54);
            subfieldIndex++;
            fieldIndex++;
        ...
        private static Mesg CreateSplitMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("AvgSpeed", 4, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("StartTime", 9, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("TotalAscent", 13, 132, 1, 0, "m", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("TotalDescent", 14, 132, 1, 0, "m", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("StartPositionLat", 21, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("StartPositionLong", 22, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("EndPositionLat", 23, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("EndPositionLong", 24, 133, 1, 0, "semicircles", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("MaxSpeed", 25, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("AvgVertSpeed", 26, 133, 1000, 0, "m/s", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("EndTime", 27, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("TotalCalories", 28, 134, 1, 0, "kcal", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("StartElevation", 74, 134, 5, 500, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalMovingTime", 110, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateSplitSummaryMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("SplitSummary", MesgNum.SplitSummary);
            fieldIndex = 0;
            newMesg.SetField(new Field("MessageIndex", 254, 132, 1, 0, "", false, Type.MessageIndex));
            fieldIndex++;
            newMesg.SetField(new Field("SplitType", 0, 0, 1, 0, "", false, Type.SplitType));
            fieldIndex++;
            newMesg.SetField(new Field("NumSplits", 3, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("TotalTimerTime", 4, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalDistance", 5, 134, 100, 0, "m", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("AvgSpeed", 6, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("MaxSpeed", 7, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalAscent", 8, 132, 1, 0, "m", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("TotalDescent", 9, 132, 1, 0, "m", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AvgHeartRate", 10, 2, 1, 0, "bpm", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("MaxHeartRate", 11, 2, 1, 0, "bpm", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AvgVertSpeed", 12, 133, 1000, 0, "m/s", false, Type.Sint32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalCalories", 13, 134, 1, 0, "kcal", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("TotalMovingTime", 77, 134, 1000, 0, "s", false, Type.Uint32));
            fieldIndex++;
        ...
        private static Mesg CreateWorkoutMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("WktDescription", 17, 7, 1, 0, "", false, Type.String));
            fieldIndex++;
        ...
        private static Mesg CreateWeightScaleMesg()
        {
            ...
            fieldIndex++;
            newMesg.SetField(new Field("Bmi", 13, 132, 10, 0, "kg/m^2", false, Type.Uint16));
            fieldIndex++;
        ...
        private static Mesg CreateMonitoringHrDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("MonitoringHrData", MesgNum.MonitoringHrData);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("RestingHeartRate", 0, 2, 1, 0, "bpm", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("CurrentDayRestingHeartRate", 1, 2, 1, 0, "bpm", false, Type.Uint8));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateSpo2DataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("Spo2Data", MesgNum.Spo2Data);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("ReadingSpo2", 0, 2, 1, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("ReadingConfidence", 1, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("Mode", 2, 0, 1, 0, "", false, Type.Spo2MeasurementType));
            fieldIndex++;
        ...
        private static Mesg CreateMaxMetDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("MaxMetData", MesgNum.MaxMetData);
            fieldIndex = 0;
            newMesg.SetField(new Field("UpdateTime", 0, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("Vo2Max", 2, 132, 10, 0, "mL/kg/min", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Sport", 5, 0, 1, 0, "", false, Type.Sport));
            fieldIndex++;
            newMesg.SetField(new Field("SubSport", 6, 0, 1, 0, "", false, Type.SubSport));
            fieldIndex++;
            newMesg.SetField(new Field("MaxMetCategory", 8, 0, 1, 0, "", false, Type.MaxMetCategory));
            fieldIndex++;
            newMesg.SetField(new Field("CalibratedData", 9, 0, 1, 0, "", false, Type.Bool));
            fieldIndex++;
            newMesg.SetField(new Field("HrSource", 12, 0, 1, 0, "", false, Type.MaxMetHeartRateSource));
            fieldIndex++;
            newMesg.SetField(new Field("SpeedSource", 13, 0, 1, 0, "", false, Type.MaxMetSpeedSource));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHsaBodyBatteryDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HsaBodyBatteryData", MesgNum.HsaBodyBatteryData);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("ProcessingInterval", 0, 132, 1, 0, "s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Level", 1, 1, 1, 0, "percent", false, Type.Sint8));
            fieldIndex++;
            newMesg.SetField(new Field("Charged", 2, 131, 1, 0, "", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("Uncharged", 3, 131, 1, 0, "", false, Type.Sint16));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHsaEventMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HsaEvent", MesgNum.HsaEvent);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("EventId", 0, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHsaAccelerometerDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HsaAccelerometerData", MesgNum.HsaAccelerometerData);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("TimestampMs", 0, 132, 1, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("SamplingInterval", 1, 132, 1, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("AccelX", 2, 131, 1.024, 0, "mG", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("AccelY", 3, 131, 1.024, 0, "mG", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("AccelZ", 4, 131, 1.024, 0, "mG", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("Timestamp32k", 5, 134, 1, 0, "", false, Type.Uint32));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHsaGyroscopeDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HsaGyroscopeData", MesgNum.HsaGyroscopeData);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("TimestampMs", 0, 132, 1, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("SamplingInterval", 1, 132, 1, 0, "1/32768 s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("GyroX", 2, 131, 28.57143, 0, "deg/s", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("GyroY", 3, 131, 28.57143, 0, "deg/s", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("GyroZ", 4, 131, 28.57143, 0, "deg/s", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("Timestamp32k", 5, 134, 1, 0, "1/32768 s", false, Type.Uint32));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHsaStepDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HsaStepData", MesgNum.HsaStepData);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("ProcessingInterval", 0, 132, 1, 0, "s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Steps", 1, 134, 1, 0, "steps", false, Type.Uint32));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHsaSpo2DataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HsaSpo2Data", MesgNum.HsaSpo2Data);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("ProcessingInterval", 0, 132, 1, 0, "s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("ReadingSpo2", 1, 2, 1, 0, "percent", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("Confidence", 2, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHsaStressDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HsaStressData", MesgNum.HsaStressData);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("ProcessingInterval", 0, 132, 1, 0, "s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("StressLevel", 1, 1, 1, 0, "s", false, Type.Sint8));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHsaRespirationDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HsaRespirationData", MesgNum.HsaRespirationData);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("ProcessingInterval", 0, 132, 1, 0, "s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("RespirationRate", 1, 131, 100, 0, "breaths/min", false, Type.Sint16));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHsaHeartRateDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HsaHeartRateData", MesgNum.HsaHeartRateData);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("ProcessingInterval", 0, 132, 1, 0, "s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Status", 1, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("HeartRate", 2, 2, 1, 0, "bpm", false, Type.Uint8));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHsaConfigurationDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HsaConfigurationData", MesgNum.HsaConfigurationData);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("Data", 0, 13, 1, 0, "", false, Type.Byte));
            fieldIndex++;
            newMesg.SetField(new Field("DataSize", 1, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHsaWristTemperatureDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HsaWristTemperatureData", MesgNum.HsaWristTemperatureData);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("ProcessingInterval", 0, 132, 1, 0, "s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Value", 1, 132, 1000, 0, "degC", false, Type.Uint16));
            fieldIndex++;
        ...
        private static Mesg CreateSleepLevelMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("SleepLevel", MesgNum.SleepLevel);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "s", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("SleepLevel", 0, 0, 1, 0, "", false, Type.SleepLevel));
            fieldIndex++;
        ...
        private static Mesg CreateAadAccelFeaturesMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("AadAccelFeatures", MesgNum.AadAccelFeatures);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("Time", 0, 132, 1, 0, "s", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("EnergyTotal", 1, 134, 1, 0, "", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("ZeroCrossCnt", 2, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Instance", 3, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("TimeAboveThreshold", 4, 132, 25, 0, "s", false, Type.Uint16));
            fieldIndex++;
        ...
        private static Mesg CreateBeatIntervalsMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("BeatIntervals", MesgNum.BeatIntervals);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("TimestampMs", 0, 132, 1, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Time", 1, 132, 1, 0, "ms", false, Type.Uint16));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHrvStatusSummaryMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HrvStatusSummary", MesgNum.HrvStatusSummary);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("WeeklyAverage", 0, 132, 128, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("LastNightAverage", 1, 132, 128, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("LastNight5MinHigh", 2, 132, 128, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("BaselineLowUpper", 3, 132, 128, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("BaselineBalancedLower", 4, 132, 128, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("BaselineBalancedUpper", 5, 132, 128, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Status", 6, 0, 1, 0, "", false, Type.HrvStatus));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateHrvValueMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("HrvValue", MesgNum.HrvValue);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("Value", 0, 132, 128, 0, "ms", false, Type.Uint16));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateRawBbiMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("RawBbi", MesgNum.RawBbi);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("TimestampMs", 0, 132, 1, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Data", 1, 132, 1, 0, "", false, Type.Uint16));
            newMesg.FieldsList[fieldIndex].components.Add(new FieldComponent(2, false, 14, 1, 0)); // time
            newMesg.FieldsList[fieldIndex].components.Add(new FieldComponent(3, false, 1, 1, 0)); // quality
            newMesg.FieldsList[fieldIndex].components.Add(new FieldComponent(4, false, 1, 1, 0)); // gap
            newMesg.FieldsList[fieldIndex].components.Add(new FieldComponent(2, false, 14, 1, 0)); // time
            newMesg.FieldsList[fieldIndex].components.Add(new FieldComponent(3, false, 1, 1, 0)); // quality
            newMesg.FieldsList[fieldIndex].components.Add(new FieldComponent(4, false, 1, 1, 0)); // gap
            newMesg.FieldsList[fieldIndex].components.Add(new FieldComponent(2, false, 14, 1, 0)); // time
            ...
            newMesg.FieldsList[fieldIndex].components.Add(new FieldComponent(4, false, 1, 1, 0)); // gap
            fieldIndex++;
            newMesg.SetField(new Field("Time", 2, 132, 1, 0, "ms", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("Quality", 3, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("Gap", 4, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateRespirationRateMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("RespirationRate", MesgNum.RespirationRate);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("RespirationRate", 0, 131, 100, 0, "breaths/min", false, Type.Sint16));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateChronoShotSessionMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("ChronoShotSession", MesgNum.ChronoShotSession);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("MinSpeed", 0, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("MaxSpeed", 1, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("AvgSpeed", 2, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("ShotCount", 3, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
            newMesg.SetField(new Field("ProjectileType", 4, 0, 1, 0, "", false, Type.ProjectileType));
            fieldIndex++;
            newMesg.SetField(new Field("GrainWeight", 5, 134, 10, 0, "gr", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("StandardDeviation", 6, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;

            return newMesg;
        }
        
        private static Mesg CreateChronoShotDataMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("ChronoShotData", MesgNum.ChronoShotData);
            fieldIndex = 0;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("ShotSpeed", 0, 134, 1000, 0, "m/s", false, Type.Uint32));
            fieldIndex++;
            newMesg.SetField(new Field("ShotNum", 1, 132, 1, 0, "", false, Type.Uint16));
            fieldIndex++;
        ...
        private static Mesg CreateSleepAssessmentMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("SleepAssessment", MesgNum.SleepAssessment);
            fieldIndex = 0;
            newMesg.SetField(new Field("CombinedAwakeScore", 0, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AwakeTimeScore", 1, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AwakeningsCountScore", 2, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("DeepSleepScore", 3, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("SleepDurationScore", 4, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("LightSleepScore", 5, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("OverallSleepScore", 6, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("SleepQualityScore", 7, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("SleepRecoveryScore", 8, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("RemSleepScore", 9, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("SleepRestlessnessScore", 10, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AwakeningsCount", 11, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("InterruptionsScore", 14, 2, 1, 0, "", false, Type.Uint8));
            fieldIndex++;
            newMesg.SetField(new Field("AverageStressDuringSleep", 15, 132, 100, 0, "", false, Type.Uint16));
            fieldIndex++;
        ...
        private static Mesg CreateNapEventMesg()
        {
            ushort fieldIndex, subfieldIndex;
            Mesg newMesg = new Mesg("NapEvent", MesgNum.NapEvent);
            fieldIndex = 0;
            newMesg.SetField(new Field("MessageIndex", 254, 132, 1, 0, "", false, Type.MessageIndex));
            fieldIndex++;
            newMesg.SetField(new Field("Timestamp", 253, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("StartTime", 0, 134, 1, 0, "seconds", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("StartTimezoneOffset", 1, 131, 1, 0, "minutes", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("EndTime", 2, 134, 1, 0, "seconds", false, Type.DateTime));
            fieldIndex++;
            newMesg.SetField(new Field("EndTimezoneOffset", 3, 131, 1, 0, "minutes", false, Type.Sint16));
            fieldIndex++;
            newMesg.SetField(new Field("Feedback", 4, 0, 1, 0, "", false, Type.NapPeriodFeedback));
            fieldIndex++;
            newMesg.SetField(new Field("IsDeleted", 5, 0, 1, 0, "", false, Type.Bool));
            fieldIndex++;
            newMesg.SetField(new Field("Source", 6, 0, 1, 0, "", false, Type.NapSource));
            fieldIndex++;
            newMesg.SetField(new Field("UpdateTimestamp", 7, 134, 1, 0, "", false, Type.DateTime));
            fieldIndex++;
